...
const Breadcrumb = () => {
  ...
  return (
    <nav className="flex items-center space-x-1.5 text-[11px] font-semibold text-text-secondary uppercase tracking-wider" aria-label="Breadcrumb">
      ...
      {pathnames.length === 0 || (pathnames.length === 1 && pathnames[0] === 'dashboard') ? (
        <span className="text-text-main font-bold select-none">Dashboard</span>
      ) : (
        <>
...
// Let's also export as Breadcrumbs for compatibility!
